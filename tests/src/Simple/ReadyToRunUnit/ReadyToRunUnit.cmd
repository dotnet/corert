...
echo %3 run --project %4 %5 "%1\%2" %~dp0methodWhiteList.txt /testargs %~dp0TestTextFile.txt
call %3 run --project %4 %5 "%1\%2" %~dp0methodWhiteList.txt /testargs %~dp0TestTextFile.txt
