...
- Windows, MacOS and Linux x64 w/ RyuJIT codegen: Simple apps. Check our [ASP.NET Core](https://github.com/dotnet/corert/tree/master/samples/WebApi/) and [MonoGame](https://github.com/dotnet/corert/tree/master/samples/MonoGame/) samples.
