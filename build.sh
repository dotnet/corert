...
install_dotnet_cli()
{
    ...
    if [ ! -f "${__cli_dir}/dotnet" ]; then
        ...
        local __cli_tarball=dotnet-dev-${__build_os_lowercase}-${__build_arch_lowercase}.1.0.0-beta-002131.tar.gz
        local __cli_tarball_path=${__tools_dir}/${__cli_tarball}
        download_file ${__cli_tarball_path} "https://dotnetcli.blob.core.windows.net/dotnet/beta/Binaries/1.0.0-beta-002131/${__cli_tarball}"
