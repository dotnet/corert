...
namespace Internal.IL
{
    ...
    public struct ILDisassembler
    {
        ...
        public ILInstruction GetNextILInstruction()
        {
            ILOpcode opCode = (ILOpcode)ReadILByte();
            if (opCode == ILOpcode.prefix1)
            {
            ...
            switch (opCode)
            {
                ...
                case ILOpcode.stloc_s:
                case ILOpcode.ldc_i4_s:
                    return new ILInstruction(_currentOffset, opCode, ReadILByte());
                ...
                case ILOpcode.ldloca:
                case ILOpcode.stloc:
                    return new ILInstruction(_currentOffset, opCode, ReadILUInt16());

                case ILOpcode.ldc_i4:
                    return new ILInstruction(_currentOffset, opCode, ReadILUInt32());

                case ILOpcode.ldc_r4:
                    return new ILInstruction(_currentOffset, opCode, ReadILFloat());

                case ILOpcode.ldc_i8:
                    return new ILInstruction(_currentOffset, opCode, ReadILUInt64());

                case ILOpcode.ldc_r8:
                    return new ILInstruction(_currentOffset, opCode, ReadILDouble());
                ...
                case ILOpcode.constrained:
                case ILOpcode.sizeof_:
                    return new ILInstruction(_currentOffset, opCode, _methodIL.GetObject(ReadILToken()));
                ...
                case ILOpcode.ble_un_s:
                case ILOpcode.blt_un_s:
                    return new ILInstruction(_currentOffset, opCode, (sbyte)ReadILByte() + _currentOffset);
                ...
                case ILOpcode.ble_un:
                case ILOpcode.blt_un:
                    return new ILInstruction(_currentOffset, opCode, (int)ReadILUInt32() + _currentOffset);
                ...
                case ILOpcode.switch_:
                    {
                        ...
                        {
                            int delta = (int)ReadILUInt32();
                            offsets[i] = jmpBase + delta;
                        }

                        return new ILInstruction(_currentOffset, opCode, offsets);
                    }
