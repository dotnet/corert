...
namespace ILCompiler.IBC
{
    ...
    public enum EncodeMethodSigFlags
    {
        ...
        ENCODE_METHOD_SIG_FLAGS_MASK = 0x0F
    };
    ...
    public static class Macros
    {
        ...
        { return (flags & (uint)EncodeMethodSigFlags.ENCODE_METHOD_SIG_MethodInstantiation) != 0; }
        public static bool IsSlotUsedInsteadOfToken(uint flags)
        { return (flags & (uint)EncodeMethodSigFlags.ENCODE_METHOD_SIG_SlotInsteadOfToken) != 0; }
        public static bool IsUnboxingStub(uint flags)
        { return (flags & (uint)EncodeMethodSigFlags.ENCODE_METHOD_SIG_UnboxingStub) != 0; }
        public static bool IsInstantiatingStub(uint flags)
        { return (flags & (uint)EncodeMethodSigFlags.ENCODE_METHOD_SIG_InstantiatingStub) != 0; }
    }
    ...
    public enum CorElementType : byte
    {
        ...
        ELEMENT_TYPE_VAR_ZAPSIG = 0x3b, // zapsig for a VAR or MVAR
        ELEMENT_TYPE_NATIVE_ARRAY_TEMPLATE_ZAPSIG = 0x3c, // prefix for an array represented as a method table
        ELEMENT_TYPE_NATIVE_VALUETYPE_ZAPSIG = 0x3d, // prefix to denote a native value type (for IL stubs)
        ELEMENT_TYPE_CANON_ZAPSIG = 0x3e,     // System.__Canon
        ELEMENT_TYPE_MODULE_ZAPSIG = 0x3f,     // escape prefix for external module reference
