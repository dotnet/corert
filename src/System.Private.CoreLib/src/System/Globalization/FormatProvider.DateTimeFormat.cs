        ...
        */
        ...
        class DateTimeFormat
        {
            ...
            internal unsafe static void FormatDigits(StringBuilder outputBuffer, int value, int len, bool overrideLengthLimit)
            {
                ...
                outputBuffer.Append(charBuff, index, digits);
            }
            ...
            */
            ...
            internal static String GetRealFormat(String format, DateTimeFormatInfo dtfi)
            {
                ...
                switch (format[0])
                {
                    ...
                    case 'o':
                    case 'O':
                        realFormat = DateTimeFormatInfo.RoundtripFormat;
                        break;
                    case 'r':
            ...
            internal static String Format(DateTime dateTime, String format, IFormatProvider dtfi)
            {
            ...
            internal static String Format(DateTime dateTime, String format, IFormatProvider provider, TimeSpan offset)
            {
                ...
                if (format == null || format.Length == 0)
                {
                    ...
                    else
                    {
                        ...
                        if (timeOnlySpecialCase)
                        {
                            format = DateTimeFormatInfo.RoundtripDateTimeUnfixed;
                        }
                        else
                        {
            ...
            internal static String[] GetAllDateTimes(DateTime dateTime, IFormatProvider dtfi)
            {
                LowLevelList<String> results = new LowLevelList<String>(DEFAULT_ALL_DATETIMES_SIZE);
