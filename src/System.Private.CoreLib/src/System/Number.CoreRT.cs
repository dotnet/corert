...
namespace System
{
    ...
    internal static partial class Number
    {
                ...
                case 'r':
                    {
                        ...
                        {
                            NumberToString(ref sb, ref number, 'G', DOUBLE_PRECISION, info, false);
                        }
                        else
                        {
                            DoubleToNumber(value, 17, ref number);
                            NumberToString(ref sb, ref number, 'G', 17, info, false);
                        }
                        return sb.GetString();
                    }
        ...
        internal static Boolean NumberBufferToDouble(ref NumberBuffer number, ref Double value)
        {
