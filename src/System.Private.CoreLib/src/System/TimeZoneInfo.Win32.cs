...
#pragma warning disable 0420
        class CachedData
        {
            ...
            public LowLevelDictionaryWithIEnumerable<string, TimeZoneInfo> m_systemTimeZones;
...
#pragma warning restore 0420
        ...
        public override int GetHashCode() {
            return m_id.ToUpper().GetHashCode();
        }
            ...
            lock (cachedData) {
                if (cachedData.m_readOnlySystemTimeZones == null) {               
                    ...
                    if (cachedData.m_systemTimeZones != null) {
                        ...
                        foreach(KeyValuePair<string, TimeZoneInfo> pair in cachedData.m_systemTimeZones) {
                            list.Add(pair.Value);
                        }
                    }
        ...
        static private TimeZoneInfoResult TryGetTimeZone(string id, Boolean dstDisabled, out TimeZoneInfo value, out Exception e, CachedData cachedData) {
            ...
            if (!cachedData.m_allSystemTimeZonesRead) {
                ...
                if (result == TimeZoneInfoResult.Success) {
                    if (cachedData.m_systemTimeZones == null)
                        cachedData.m_systemTimeZones = new LowLevelDictionaryWithIEnumerable<string, TimeZoneInfo>();
        ...
        static private void ValidateTimeZoneInfo(
            ...
            if (id.Length == 0) {
                throw new ArgumentException(String.Format(SR.Argument_InvalidId, id), "id");
            }
