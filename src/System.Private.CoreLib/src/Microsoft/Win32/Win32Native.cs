    ...
    internal static class Win32Native {
        ...
        internal static String GetMessage(int errorCode) {
            ...
            if (result != 0) {
                ...
                return String.Format(SR.UnknownError_Num, errorCode);
            }
        }
        ...
        [DllImport(KERNEL32, EntryPoint="GetSystemDirectoryW", CharSet=CharSet.Auto, SetLastError=true, BestFitMapping=false)]
