...
namespace System.Runtime.InteropServices
{
    ...
    public unsafe abstract partial class McgModule
    {
            ...
            Func<int> getTableSize)
        {
            ...
            // Verify guid generated by dynmaic interop is same as mcg generated
            if (!m_guidVerified && McgModuleManager.UseDynamicInterop)
            {
                // Need to set m_guidVerified to first to avoid StackOverflow,
                // Due inside VerifyWinRTGenericInterfaceGuids(), it will call LookupTypeHandleInHashtable
                m_guidVerified = true;
