...
namespace Internal.Reflection.Execution
{
    ...
    public sealed partial class AssemblyBinderImplementation : AssemblyBinder
    {
        ...
        public sealed override bool Bind(byte[] rawAssembly, byte[] rawSymbolStore, bool cacheMissedLookups, out AssemblyBindResult bindResult, out Exception exception)
        {
            bool? result = null;
            exception = null;
            bindResult = default(AssemblyBindResult);

            BindEcmaByteArray(rawAssembly, rawSymbolStore, cacheMissedLookups, ref bindResult, ref exception, ref result);
