...
#ifdef CORERT
    // with the JIT, the locals of the enclosing method are reported even for filter funclets,
    // which are called in the first pass with m_idxCurClause == 0xFFFFFFFF
    if (activeFuncletFramePointer == NULL)
#else
