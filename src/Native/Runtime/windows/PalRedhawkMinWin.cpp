...
#if (defined(_TARGET_AMD64_) || defined (TARGET_X86)) && !defined(USE_PORTABLE_HELPERS)
...
#endif // _DEBUG
#endif // (defined(_TARGET_AMD64_) || defined (TARGET_X86)) && !defined(USE_PORTABLE_HELPERS)
...
#else  // (defined(_TARGET_AMD64_) || defined (TARGET_X86)) && !defined(USE_PORTABLE_HELPERS)
