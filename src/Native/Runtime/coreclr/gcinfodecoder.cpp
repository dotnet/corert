                                ...
                                void *          hCallBack)
{
    ...
    _ASSERTE( IS_ALIGNED( pObjRef, sizeof( void* ) ) );
    ...
    pCallBack(hCallBack, (PTR_PTR_VOID)pObjRef, gcFlags DAC_ARG(DacSlotLocation(GetStackReg(spBase), spOffset, true)));
}
