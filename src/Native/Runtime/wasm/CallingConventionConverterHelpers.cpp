...
void __jmpstub__CallingConventionConverter_CommonCallingStub(CommonCallingStubInputData inputData)
{
    assert(false);
}

void CallingConventionConverter_GetStubs(void *returnVoidStub, void *returnIntegerStub, void *commonCallingStub)
{
    assert(false);
}
