...
////////////////////////////////////////////////////////////////////////////////
//
// Ported from desktop (BCL\System\DefaultBinder.cs), then cut down to eliminate 
// features that weren't part of .NET Core 1.0.
//
// This file now only exists to keep .Net Native functionality from regressing
// as we bring back the full surface area. We'll need to port the full default binder
// from the desktop - once that's done, this file will be deleted.
//
//
...
namespace System.Reflection.Runtime.BindingFlagSupport
{
    ...
    {
        private static class LimitedBinder
        {
