            ...
            get
            {
                ...
                if (adder == null)
                {
                    foreach (MethodSemanticsHandle methodSemanticsHandle in _event.MethodSemantics)
                    {
                        ...
                        {
                            return _lazyAdder = RuntimeNamedMethodInfoWithMetadata<RuntimeMethodCommon>.GetRuntimeNamedMethodInfo(new RuntimeMethodCommon(methodSemantics.Method, _definingTypeInfo, _contextTypeInfo), _reflectedType);
                        }
                    }
        ...
        public sealed override MethodInfo RaiseMethod
        {
            get
            {
                ...
                foreach (MethodSemanticsHandle methodSemanticsHandle in _event.MethodSemantics)
                {
                    ...
                    {
                        return RuntimeNamedMethodInfoWithMetadata<RuntimeMethodCommon>.GetRuntimeNamedMethodInfo(new RuntimeMethodCommon(methodSemantics.Method, _definingTypeInfo, _contextTypeInfo), _reflectedType);
                    }
                }
                return null;
            }
            ...
            get
            {
                ...
                if (remover == null)
                {
                    foreach (MethodSemanticsHandle methodSemanticsHandle in _event.MethodSemantics)
                    {
                        ...
                        {
                            return _lazyRemover = RuntimeNamedMethodInfoWithMetadata<RuntimeMethodCommon>.GetRuntimeNamedMethodInfo(new RuntimeMethodCommon(methodSemantics.Method, _definingTypeInfo, _contextTypeInfo), _reflectedType);
                        }
                    }
