...
namespace Internal.JitInterface
{
    unsafe partial class CorInfoImpl
    {
        ...
        {
            IntPtr * callbacks = (IntPtr *)Marshal.AllocCoTaskMem(sizeof(IntPtr) * 178);
            Object[] delegates = new Object[178];
