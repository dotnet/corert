...
namespace Internal.JitInterface
{
    unsafe partial class CorInfoImpl
    {
        ...
        {
            IntPtr * callbacks = (IntPtr *)Marshal.AllocCoTaskMem(sizeof(IntPtr) * 172);
            Object[] delegates = new Object[172];
            ...
            delegates[130] = d130;
            var d131 = new __getPInvokeUnmanagedTarget(_getPInvokeUnmanagedTarget);
            callbacks[131] = Marshal.GetFunctionPointerForDelegate(d131);
            delegates[131] = d131;
            var d132 = new __getAddressOfPInvokeFixup(_getAddressOfPInvokeFixup);
            callbacks[132] = Marshal.GetFunctionPointerForDelegate(d132);
            delegates[132] = d132;
            var d133 = new __getAddressOfPInvokeTarget(_getAddressOfPInvokeTarget);
            callbacks[133] = Marshal.GetFunctionPointerForDelegate(d133);
            delegates[133] = d133;
            var d134 = new __GetCookieForPInvokeCalliSig(_GetCookieForPInvokeCalliSig);
            callbacks[134] = Marshal.GetFunctionPointerForDelegate(d134);
            delegates[134] = d134;
            var d135 = new __canGetCookieForPInvokeCalliSig(_canGetCookieForPInvokeCalliSig);
            callbacks[135] = Marshal.GetFunctionPointerForDelegate(d135);
            delegates[135] = d135;
            var d136 = new __getJustMyCodeHandle(_getJustMyCodeHandle);
            callbacks[136] = Marshal.GetFunctionPointerForDelegate(d136);
            delegates[136] = d136;
            var d137 = new __GetProfilingHandle(_GetProfilingHandle);
            callbacks[137] = Marshal.GetFunctionPointerForDelegate(d137);
            delegates[137] = d137;
            var d138 = new __getCallInfo(_getCallInfo);
            callbacks[138] = Marshal.GetFunctionPointerForDelegate(d138);
            delegates[138] = d138;
            var d139 = new __canAccessFamily(_canAccessFamily);
            callbacks[139] = Marshal.GetFunctionPointerForDelegate(d139);
            delegates[139] = d139;
            var d140 = new __isRIDClassDomainID(_isRIDClassDomainID);
            callbacks[140] = Marshal.GetFunctionPointerForDelegate(d140);
            delegates[140] = d140;
            var d141 = new __getClassDomainID(_getClassDomainID);
            callbacks[141] = Marshal.GetFunctionPointerForDelegate(d141);
            delegates[141] = d141;
            var d142 = new __getFieldAddress(_getFieldAddress);
            callbacks[142] = Marshal.GetFunctionPointerForDelegate(d142);
            delegates[142] = d142;
            var d143 = new __getVarArgsHandle(_getVarArgsHandle);
            callbacks[143] = Marshal.GetFunctionPointerForDelegate(d143);
            delegates[143] = d143;
            var d144 = new __canGetVarArgsHandle(_canGetVarArgsHandle);
            callbacks[144] = Marshal.GetFunctionPointerForDelegate(d144);
            delegates[144] = d144;
            var d145 = new __constructStringLiteral(_constructStringLiteral);
            callbacks[145] = Marshal.GetFunctionPointerForDelegate(d145);
            delegates[145] = d145;
            var d146 = new __emptyStringLiteral(_emptyStringLiteral);
            callbacks[146] = Marshal.GetFunctionPointerForDelegate(d146);
            delegates[146] = d146;
            var d147 = new __getFieldThreadLocalStoreID(_getFieldThreadLocalStoreID);
            callbacks[147] = Marshal.GetFunctionPointerForDelegate(d147);
            delegates[147] = d147;
            var d148 = new __setOverride(_setOverride);
            callbacks[148] = Marshal.GetFunctionPointerForDelegate(d148);
            delegates[148] = d148;
            var d149 = new __addActiveDependency(_addActiveDependency);
            callbacks[149] = Marshal.GetFunctionPointerForDelegate(d149);
            delegates[149] = d149;
            var d150 = new __GetDelegateCtor(_GetDelegateCtor);
            callbacks[150] = Marshal.GetFunctionPointerForDelegate(d150);
            delegates[150] = d150;
            var d151 = new __MethodCompileComplete(_MethodCompileComplete);
            callbacks[151] = Marshal.GetFunctionPointerForDelegate(d151);
            delegates[151] = d151;
            var d152 = new __getTailCallCopyArgsThunk(_getTailCallCopyArgsThunk);
            callbacks[152] = Marshal.GetFunctionPointerForDelegate(d152);
            delegates[152] = d152;
            var d153 = new __getMemoryManager(_getMemoryManager);
