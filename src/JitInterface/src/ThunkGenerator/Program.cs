...
");
            ...
            foreach (FunctionDecl decl in functionData)
            {
                tr.WriteLine("            d = new _" + decl.FunctionName + "(" + decl.FunctionName + ");");
                tr.WriteLine("            vtable[" + index + "] = Marshal.GetFunctionPointerForDelegate(d);");
                tr.WriteLine("            keepalive[" + index + "] = d;");
                index++;
            }
