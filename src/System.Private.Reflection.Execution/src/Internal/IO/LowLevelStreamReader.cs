...
namespace Internal.IO
{
    ...
    // 
    internal class LowLevelStreamReader //: TextReader
    {
        // StreamReader.Null is threadsafe.
        public static readonly LowLevelStreamReader Null = new NullStreamReader();
        ...
        internal LowLevelStreamReader()
        {
        }

        public LowLevelStreamReader(Stream stream)
            : this(stream, true)
        {
        }

        public LowLevelStreamReader(Stream stream, bool detectEncodingFromByteOrderMarks)
            : this(stream, Encoding.UTF8, detectEncodingFromByteOrderMarks, DefaultBufferSize, false)
        {
        }

        public LowLevelStreamReader(Stream stream, Encoding encoding)
            : this(stream, encoding, true, DefaultBufferSize, false)
        {
        }

        public LowLevelStreamReader(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks)
        ...
        // 
        public LowLevelStreamReader(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks, int bufferSize)
            : this(stream, encoding, detectEncodingFromByteOrderMarks, bufferSize, false)
        {
        }

        public LowLevelStreamReader(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks, int bufferSize, bool leaveOpen)
        {
        ...
        */
        ...
        private class NullStreamReader : LowLevelStreamReader
        {
