...
:HelpVarCall
call %~dp0cibuild\buildvars-setup.cmd -help
exit /b 1

:NormalVarCall
call %~dp0cibuild\buildvars-setup.cmd %*
...
call %~dp0cibuild\build-native.cmd %*
...
call %~dp0cibuild\build-managed.cmd %*
...
call %~dp0cibuild\build-tests.cmd %*
